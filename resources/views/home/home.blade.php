...
@section('content')
    ...
    <form action="{{ route('search') }}" method="GET" class="container my-4" role="search" aria-label="Formulaire de recherche de professionnels">
        <div class="row g-2 align-items-end">

            <div class="col-md">
                <label for="job_categories" >Praticien</label>
            ...
            <div class="col-md">
                <label for="animal_categories" >Animaux</label>
            ...
            <div class="col-auto">
                <button type="submit" class="btn btn-primary btn-custom"
                        aria-label="Rechercher des professionnels selon les critères sélectionnés">
